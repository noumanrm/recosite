...
this.n.showmore.find("a.asp_showmore").trigger("click"))},initAutop:function(){if(null!=x&&!this.o.compact.enabled&&this.triggerPrevState)return this.searchWithCheck(800),x=null,!1;if("disabled"==this.o.autop.state)return!1;var a=window.location.href;if(-1<a.indexOf("asp_ls=")||-1<a.indexOf("asp_ls&"))return!1;a=this.o.show_more.enabled&&"ajax"==this.o.show_more.action?!1:this.o.autop.count;this.isAutoP=!0;1==this.o.compact.enabled&&this.openCompact();"phrase"==this.o.autop.state?(this.n.text.val(this.o.autop.phrase),
this.search(a)):"latest"==this.o.autop.state?this.search(a,1):this.search(a,2)},initEtc:function(){var a=this,d=null;a.n.trythis.css({visibility:"visible"});b("div.asp_option",a.n.searchsettings).on(a.mouseupTouchend,function(c){c.preventDefault();c.stopImmediatePropagation();if(a.dragging)return!1;b('input[type="checkbox"]',this).prop("checked",!b('input[type="checkbox"]',this).prop("checked"));clearTimeout(d);var f=this;d=setTimeout(function(){b('input[type="checkbox"]',f).trigger("asp_chbx_change")},
50)});b("div.asp_option label",a.n.searchsettings).on("click",function(c){c.preventDefault()});b("fieldset.asp_checkboxes_filter_box",a.n.searchsettings).each(function(){var c=!0;b('.asp_option:not(.asp_option_selectall) input[type="checkbox"]',this).each(function(){if(1==b(this).prop("checked"))return c=!1});c&&b('.asp_option_selectall input[type="checkbox"]',this).prop("checked",!1).removeAttr("data-origvalue")});b("fieldset",a.n.searchsettings).each(function(){b(".asp_option:not(.hiddend)",this).last().addClass("asp-o-last")});
...
"fixed"),this.o.blocking||this.n.searchsettings.css("position","fixed")},initNavigationEvent:function(){var a=this;b(a.n.resultsDiv).on("mouseenter",".item",function(){b(".item",a.n.resultsDiv).removeClass("hovered");b(this).addClass("hovered")});b(a.n.resultsDiv).on("mouseleave",".item",function(){b(".item",a.n.resultsDiv).removeClass("hovered")});var d=function(c){var f=c.keyCode||c.which;if(0<b(".item",a.n.resultsDiv).length&&"none"!=a.n.resultsDiv.css("display")&&"vertical"==a.o.resultstype){if(40==
f||38==f){40==f&&(a.n.text.trigger("blur"),0==b(".item.hovered",a.n.resultsDiv).length?b(".item",a.n.resultsDiv).first().addClass("hovered"):b(".item.hovered",a.n.resultsDiv).removeClass("hovered").next(".item").addClass("hovered"));38==f&&(a.n.text.trigger("blur"),0==b(".item.hovered",a.n.resultsDiv).length?b(".item",a.n.resultsDiv).last().addClass("hovered"):b(".item.hovered",a.n.resultsDiv).removeClass("hovered").prev(".item").addClass("hovered"));c.stopPropagation();c.preventDefault();var g=a.is_scroll&&
"undefined"!==typeof a.scroll.getScrollElement?b(a.scroll.getScrollElement()):a.n.results,e=a.n.resultsDiv.find(".resdrg .item.hovered");0==e.length&&(e=a.n.resultsDiv.children().first());g.animate({scrollTop:e.offset().top-g.offset().top+g.scrollTop()},{duration:120})}13==f&&0<b(".item.hovered",a.n.resultsDiv).length&&(c.stopPropagation(),c.preventDefault(),b(".item.hovered a.asp_res_url",a.n.resultsDiv).get(0).click())}};a.documentEventHandlers.push({node:document,event:"keydown",handler:d});b(document).on("keydown",
d)},initMagnifierEvent:function(){var a=this;1==a.o.compact.enabled&&a.initCompactEvents();var d,c,f=!1;a.n.searchsettings.find("button.asp_s_btn").on("click",function(e){a.ktype="button";e.preventDefault();if(a.n.text.val().length>=a.o.charcount){if("ajax_search"!=a.o.sb.redirect_action)if("first_result"!=a.o.sb.redirect_action)a.doRedirectToResults("button");else{if(a.isRedirectToFirstResult())return a.doRedirectToFirstResult(),!1;a.search()}else b("form",a.n.searchsettings).serialize()+a.n.text.val().trim()==
a.lastSuccesfulSearch&&a.resultsOpened||a.search();clearTimeout(d)}});a.n.searchsettings.find("button.asp_r_btn").on("click",function(e){var l=A(b("form",a.n.searchsettings)),h=a.n.text.val();e.preventDefault();a.resetSearchFilters();"live"!=a.o.rb.action||JSON.stringify(l)==JSON.stringify(A(b("form",a.n.searchsettings)))&&""==h?"close"==a.o.rb.action&&a.hideResults():a.search(!1,!1,!1,!0,!0)});a.n.text.on("keyup",function(e){a.keycode=e.keyCode||e.which;a.ktype=e.type;if(13==a.keycode){clearTimeout(c);
c=setTimeout(function(){f=!1},300);if(f)return!1;f=!0}e=b(this).hasClass("orig");a.n.text.val().length>=a.o.charcount&&e&&"keyup"==a.ktype&&13==a.keycode&&(a.gaEvent("return"),1==a.o.redirectOnEnter?"first_result"!=a.o.trigger.return?a.doRedirectToResults(a.ktype):a.search():"ajax_search"==a.o.trigger.return&&(b("form",a.n.searchsettings).serialize()+a.n.text.val().trim()==a.lastSuccesfulSearch&&a.resultsOpened||a.search()),clearTimeout(d))});var g=a.n.text.val();a.n.promagnifier.add(a.n.text).on("click input",
function(e){a.keycode=e.keyCode||e.which;a.ktype=e.type;if("input"==a.ktype&&z()){if(g==a.n.text.val())return!1;g=a.n.text.val()}e=b(this).hasClass("orig");a.hideArrowBox();if(e&&"click"==a.ktype&&b("form",a.n.searchsettings).serialize()+a.n.text.val().trim()==a.lastSuccesfulSearch)a.resultsOpened||a.usingLiveLoader||(a._no_animations=!0,a.showResults(),a._no_animations=!1);else if(e||"click"!=a.ktype||a.gaEvent("magnifier"),!e||"click"!=a.ktype)if("click"==a.ktype||"input"==a.ktype){var l=a.n.search.attr("asp-compact")||
"closed";if(1!=a.o.compact.enabled||"click"!=a.ktype&&"touchend"!=a.ktype||1!=a.o.compact.closeOnMagnifier||"open"!=l)if(1!=a.o.compact.enabled||"click"!=a.ktype&&"touchend"!=a.ktype||"closed"!=l)if(a.n.text.val().length>=a.o.charcount&&!e&&1==a.o.redirectOnClick&&"click"==a.ktype&&"first_result"!=a.o.trigger.click)a.doRedirectToResults(a.ktype),clearTimeout(d);else if("input"!=a.ktype||0!=a.o.trigger.type)if("click"!=a.ktype||"ajax_search"==a.o.trigger.click||"first_result"==a.o.trigger.click)a.n.text.val().length<
...
b(".asp_res_url",this.n.resultsDiv).length||0<b(".asp_es_"+this.o.id+" a").length||this.o.resPage.useAjax&&0<b(this.o.resPage.selector+"a").length)&&(1==this.o.redirectOnClick&&"click"==this.ktype&&"first_result"==this.o.trigger.click||1==this.o.redirectOnEnter&&("input"==this.ktype||"keyup"==this.ktype)&&13==this.keycode&&"first_result"==this.o.trigger.return||"button"==this.ktype&&"first_result"==this.o.sb.redirect_action)},doRedirectToFirstResult:function(){var a;var d="click"==this.ktype?this.o.trigger.click_location:
...
a.searchAbort(),a.n.proloading.css("display","none"))})},openCompact:function(){var a=this;a.n.search.is("[asp-compact-w]")||(a.n.probox.attr("asp-compact-w",a.n.probox.innerWidth()),a.n.search.attr("asp-compact-w",a.n.search.innerWidth()));1==a.o.compact.enabled&&"static"!=a.o.compact.position&&a.n.trythis.css({top:a.n.search.position().top+a.n.search.outerHeight(!0)+"px",left:a.n.search.offset().left+"px"});a.n.search.css({width:a.n.search.width()+"px"});a.n.probox.css({width:"auto"});setTimeout(function(){b(">:not(.promagnifier)",
...
window.ASP.Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(d){var b="",c=0;for(d=window.ASP.Base64._utf8_encode(d);c<d.length;){var a=d.charCodeAt(c++);var f=d.charCodeAt(c++);var e=d.charCodeAt(c++);var g=a>>2;a=(a&3)<<4|f>>4;var h=(f&15)<<2|e>>6;var k=e&63;isNaN(f)?h=k=64:isNaN(e)&&(k=64);b=b+this._keyStr.charAt(g)+this._keyStr.charAt(a)+this._keyStr.charAt(h)+this._keyStr.charAt(k)}return b},decode:function(d){var b="",c=0;for(d=d.replace(/[^A-Za-z0-9\+\/=]/g,
"");c<d.length;){var a=this._keyStr.indexOf(d.charAt(c++));var f=this._keyStr.indexOf(d.charAt(c++));var e=this._keyStr.indexOf(d.charAt(c++));var g=this._keyStr.indexOf(d.charAt(c++));a=a<<2|f>>4;f=(f&15)<<4|e>>2;var h=(e&3)<<6|g;b+=String.fromCharCode(a);64!=e&&(b+=String.fromCharCode(f));64!=g&&(b+=String.fromCharCode(h))}return b=window.ASP.Base64._utf8_decode(b)},_utf8_encode:function(d){d=d.replace(/\r\n/g,"\n");for(var b="",c=0;c<d.length;c++){var a=d.charCodeAt(c);128>a?b+=String.fromCharCode(a):
(127<a&&2048>a?b+=String.fromCharCode(a>>6|192):(b+=String.fromCharCode(a>>12|224),b+=String.fromCharCode(a>>6&63|128)),b+=String.fromCharCode(a&63|128))}return b},_utf8_decode:function(d){for(var b="",c=0,a,f,e;c<d.length;)e=d.charCodeAt(c),128>e?(b+=String.fromCharCode(e),c++):191<e&&224>e?(a=d.charCodeAt(c+1),b+=String.fromCharCode((e&31)<<6|a&63),c+=2):(a=d.charCodeAt(c+1),f=d.charCodeAt(c+2),b+=String.fromCharCode((e&15)<<12|(a&63)<<6|f&63),c+=3);return b}};
window.ASP.instances={instances:[],get:function(d,b){this.clean();if("undefined"===typeof d||0==d)return this.instances;var c;if("undefined"===typeof b){b=[];for(c=0;c<this.instances.length;c++)this.instances[c].o.id==d&&b.push(this.instances[c]);return 0<b.length?b:!1}for(c=0;c<this.instances.length;c++)if(this.instances[c].o.id==d&&this.instances[c].o.iid==b)return this.instances[c];return!1},set:function(d){if(this.exist(d.o.id,d.o.iid))return!1;this.instances.push(d);return!0},exist:function(d,
b){this.clean();for(var c=0;c<this.instances.length;c++)if(this.instances[c].o.id==d&&("undefined"===typeof b||this.instances[c].o.iid==b))return!0;return!1},clean:function(){var d=jQuery,b=[],c=this;this.instances.forEach(function(a,f){0==d(".asp_m_"+a.o.rid).length&&b.push(f)});b.forEach(function(a){c.instances[a].destroy();c.instances.splice(a,1)})},destroy:function(d,b){var c=this.get(d,b);if(!1!==c)if(Array.isArray(c))c.forEach(function(f){f.destroy()}),this.instances=[];else{var a=0;this.instances.forEach(function(f,
e){f.o.id==d&&f.o.iid==b&&(a=e)});c.destroy();this.instances.splice(a,1)}}};window.ASP.getScope=function(){if("undefined"!==typeof jQuery)if("undefined"==typeof jQuery.fn.ajaxsearchpro)for(var d=jQuery,b=jQuery,c=0;10>c;c++)if("undefined"==typeof d.fn.ajaxsearchpro)d=jQuery.noConflict(!0);else return window.jQuery=window.$=b,d;else return jQuery;return window.jQuery};window.ASP.initialized=!1;
window.ASP.initialize=function(d){if("undefined"==typeof this.getScope||"undefined"==typeof this.version)return!1;var b=this.getScope(),c=".asp_init_data";"undefined"!==typeof d&&(c="div[id*=asp_init_id_"+d+"]");b(c).each(function(){var f=b(this).closest(".asp_w_container").find(".asp_m"),e=b(this).data("aspdata");if("undefined"===typeof e||0==f.length||"undefined"!=typeof f.get(0).hasAsp)return!0;e=window.ASP.Base64.decode(e);if("undefined"===typeof e||""==e)return!0;f.addClass("hasASP");f.get(0).hasAsp=
!0;return f.ajaxsearchpro(JSON.parse(e))});if(this.highlight.enabled){var a=localStorage.getItem("asp_phrase_highlight");localStorage.removeItem("asp_phrase_highlight");null!=a&&(a=JSON.parse(a),b.each(this.highlight.data,function(f,e){if(e.id==a.id)return f=""!=e.selector&&0<b(e.selector).length?e.selector:"article",f=0<b(f).length?f:"body",b(f).highlight(a.phrase,{element:"span",className:"asp_single_highlighted_"+a.id,wordsOnly:e.whole,excludeParents:".asp_w, .asp-try"}),e.scroll&&0<b(".asp_single_highlighted_"+
a.id).length&&(f=b(".asp_single_highlighted_"+a.id).offset().top-120,0<b("#wpadminbar").length&&(f-=b("#wpadminbar").height()),f+=e.scroll_offset,f=0>f?0:f,b("html").animate({scrollTop:f},{duration:500})),!1}))}this.initialized=!0};
window.ASP.ready=function(){var d=this,b=d.getScope(),c=null;b(function(){d.initialize()});b(document).on("load",function(){d.initialized||(d.initialize(),console.log("ASP initialized via window.load"))});if("undefined"!=typeof ASP.detect_ajax&&1==ASP.detect_ajax){var a=new MutationObserver(function(){clearTimeout(c);c=setTimeout(function(){d.initialize()},500)});function g(){var h=document.querySelector("body");h?a.observe(h,{subtree:!0,childList:!0}):window.setTimeout(g,500)}g()}var f,e="#menu-item-search, .fa-search, .fa, .fas";
e+=", .fusion-flyout-menu-toggle, .fusion-main-menu-search-open";e+=", #search_button";e+=", .mini-search.popup-search";e+=", .icon-search";e+=", .menu-item-search-dropdown";e+=", .mobile-menu-button";e+=", .td-icon-search, .tdb-search-icon";e+=", .side_menu_button, .search_button";e+=", .raven-search-form-toggle";e+=", [data-elementor-open-lightbox], .elementor-button-link, .elementor-button";e+=", i[class*=-search], a[class*=-search]";b(function(){b("body").on("click touchend",e,function(){clearTimeout(f);
f=setTimeout(function(){d.initialize()},500)})});if("undefined"!=typeof jQuery)jQuery(document).on("elementor/popup/show",function(){setTimeout(function(){d.initialize()},10)})};
window.ASP.api=function(){var d=function(a,f,e,g){a=ASP.instances.get(a,f);return!1!==a&&a[e].apply(a,[g])},b=function(a,f,e){if(!isNaN(parseFloat(f))&&isFinite(f))return a=ASP.instances.get(a,f),!1!==a&&a[e].apply(a);a=ASP.instances.get(a);return!1!==a&&a.forEach(function(g){g[f].apply(g,[e])})},c=function(a,f){if("exists"==f)return ASP.instances.exist(a);a=ASP.instances.get(a);return!1!==a&&a.forEach(function(e){e[f].apply(e)})};if(4==arguments.length)return d.apply(this,arguments);if(3==arguments.length)return b.apply(this,
arguments);if(2==arguments.length)return c.apply(this,arguments);0==arguments.length&&(console.log("Usage: ASP.api(id, [optional]instance, function, [optional]args);"),console.log("For more info: https://knowledgebase.ajaxsearchpro.com/other/javascript-api"))};window._ASP=ASP;window._ASP.ready();
