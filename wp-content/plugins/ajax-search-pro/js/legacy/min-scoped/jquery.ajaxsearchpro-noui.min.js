...
this.n.showmore.find("a.asp_showmore").trigger("click"))},initAutop:function(){if(null!=y&&!this.o.compact.enabled&&this.triggerPrevState)return this.searchWithCheck(800),y=null,!1;if("disabled"==this.o.autop.state)return!1;var a=p.location.href;if(-1<a.indexOf("asp_ls=")||-1<a.indexOf("asp_ls&"))return!1;a=this.o.show_more.enabled&&"ajax"==this.o.show_more.action?!1:this.o.autop.count;this.isAutoP=!0;1==this.o.compact.enabled&&this.openCompact();"phrase"==this.o.autop.state?(this.n.text.val(this.o.autop.phrase),
...
this.o.blocking||this.n.searchsettings.css("position","fixed")},initNavigationEvent:function(){var a=this;b(a.n.resultsDiv).on("mouseenter",".item",function(){b(".item",a.n.resultsDiv).removeClass("hovered");b(this).addClass("hovered")});b(a.n.resultsDiv).on("mouseleave",".item",function(){b(".item",a.n.resultsDiv).removeClass("hovered")});var d=function(c){var f=c.keyCode||c.which;if(0<b(".item",a.n.resultsDiv).length&&"none"!=a.n.resultsDiv.css("display")&&"vertical"==a.o.resultstype){if(40==f||
38==f){40==f&&(a.n.text.trigger("blur"),0==b(".item.hovered",a.n.resultsDiv).length?b(".item",a.n.resultsDiv).first().addClass("hovered"):b(".item.hovered",a.n.resultsDiv).removeClass("hovered").next(".item").addClass("hovered"));38==f&&(a.n.text.trigger("blur"),0==b(".item.hovered",a.n.resultsDiv).length?b(".item",a.n.resultsDiv).last().addClass("hovered"):b(".item.hovered",a.n.resultsDiv).removeClass("hovered").prev(".item").addClass("hovered"));c.stopPropagation();c.preventDefault();var g=a.is_scroll&&
...
a.lastSuccesfulSearch&&a.resultsOpened||a.search();clearTimeout(d)}});a.n.searchsettings.find("button.asp_r_btn").on("click",function(e){var l=B(b("form",a.n.searchsettings)),h=a.n.text.val();e.preventDefault();a.resetSearchFilters();"live"!=a.o.rb.action||JSON.stringify(l)==JSON.stringify(B(b("form",a.n.searchsettings)))&&""==h?"close"==a.o.rb.action&&a.hideResults():a.search(!1,!1,!1,!0,!0)});a.n.text.on("keyup",function(e){a.keycode=e.keyCode||e.which;a.ktype=e.type;if(13==a.keycode){clearTimeout(c);
...
if(1==a.o.autocomplete.enabled&&!v()||1==a.o.autocomplete.mobile&&v())a.n.text.on("keyup",function(c){a.keycode=c.keyCode||c.which;a.ktype=c.type;var f=39;b("body").hasClass("rtl")&&(f=37);a.keycode==f&&""!=a.n.textAutocomplete.val()?(c.preventDefault(),a.n.text.val(a.n.textAutocomplete.val()),0!=a.o.trigger.type&&(a.searchAbort(),a.search())):(clearTimeout(d),null!=a.postAuto&&a.postAuto.abort(),1==a.o.autocomplete.googleOnly?a.autocompleteGoogleOnly():d=setTimeout(function(){a.autocomplete();d=
null},a.o.trigger.autocomplete_delay))}),a.n.text.on("keyup mouseup input blur select",function(){a.fixAutocompleteScrollLeft()})},initPagerEvent:function(){var a=this;a.n.resultsDiv.on(a.clickTouchend+" click_trigger","nav>a",function(d){d.preventDefault();d.stopImmediatePropagation();var c=this,f=d.type;d=1;a.n.text.is(":focus")&&v()&&(a.n.text.trigger("blur"),d=300);setTimeout(function(){a.currentPage=parseInt(b(c).closest("nav").find("li.asp_active span").html(),10);b(c).hasClass("asp_prev")&&
...
"-1"==b(this).val())&&(c=!1)}));c?d.removeClass("asp-invalid"):(d.addClass("asp-invalid"),a=!1)});a||this.n.searchsettings.find("button.asp_s_btn").prop("disabled",!0);this.n.searchsettings.find("button.asp_s_btn").prop("disabled",!1);return a},showArrowBox:function(a,d){var c=this,f=b("body");0===f.find(".asp_arrow_box").length&&(f.append("<div class='asp_arrow_box'></div>"),f.find(".asp_arrow_box").on("mouseout",function(){c.hideArrowBox()}));var g=f.find(".asp_arrow_box"),e=b(a).offset().top-b(p).scrollTop();
...
this.n.resultsDiv).css("display","none")},visiblePagination:function(){return"none"!=b("nav.asp_navigation",this.n.resultsDiv).css("display")},calculateIsotopeRows:function(){var a=parseFloat(this.n.results.innerWidth());if("desktop"===D()){var d=w(this.o.isotopic.itemWidth,a);var c=w(this.o.isotopic.itemHeight,a)}else"tablet"===D()?(d=w(this.o.isotopic.itemWidthTablet,a),c=w(this.o.isotopic.itemHeightTablet,a)):(d=w(this.o.isotopic.itemWidthPhone,a),c=w(this.o.isotopic.itemHeightPhone,a));var f=
...
(function(k,n,g){g.ASP=g.ASP||{};g.ASP.Base64={_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(c){var a="",d=0;for(c=g.ASP.Base64._utf8_encode(c);d<c.length;){var b=c.charCodeAt(d++);var f=c.charCodeAt(d++);var e=c.charCodeAt(d++);var h=b>>2;b=(b&3)<<4|f>>4;var l=(f&15)<<2|e>>6;var m=e&63;isNaN(f)?l=m=64:isNaN(e)&&(m=64);a=a+this._keyStr.charAt(h)+this._keyStr.charAt(b)+this._keyStr.charAt(l)+this._keyStr.charAt(m)}return a},decode:function(c){var a="",
d=0;for(c=c.replace(/[^A-Za-z0-9\+\/=]/g,"");d<c.length;){var b=this._keyStr.indexOf(c.charAt(d++));var f=this._keyStr.indexOf(c.charAt(d++));var e=this._keyStr.indexOf(c.charAt(d++));var h=this._keyStr.indexOf(c.charAt(d++));b=b<<2|f>>4;f=(f&15)<<4|e>>2;var l=(e&3)<<6|h;a+=String.fromCharCode(b);64!=e&&(a+=String.fromCharCode(f));64!=h&&(a+=String.fromCharCode(l))}return a=g.ASP.Base64._utf8_decode(a)},_utf8_encode:function(c){c=c.replace(/\r\n/g,"\n");for(var a="",d=0;d<c.length;d++){var b=c.charCodeAt(d);
128>b?a+=String.fromCharCode(b):(127<b&&2048>b?a+=String.fromCharCode(b>>6|192):(a+=String.fromCharCode(b>>12|224),a+=String.fromCharCode(b>>6&63|128)),a+=String.fromCharCode(b&63|128))}return a},_utf8_decode:function(c){for(var a="",d=0,b,f,e;d<c.length;)e=c.charCodeAt(d),128>e?(a+=String.fromCharCode(e),d++):191<e&&224>e?(b=c.charCodeAt(d+1),a+=String.fromCharCode((e&31)<<6|b&63),d+=2):(b=c.charCodeAt(d+1),f=c.charCodeAt(d+2),a+=String.fromCharCode((e&15)<<12|(b&63)<<6|f&63),d+=3);return a}};g.ASP.instances=
{instances:[],get:function(c,a){this.clean();if("undefined"===typeof c||0==c)return this.instances;var d;if("undefined"===typeof a){a=[];for(d=0;d<this.instances.length;d++)this.instances[d].o.id==c&&a.push(this.instances[d]);return 0<a.length?a:!1}for(d=0;d<this.instances.length;d++)if(this.instances[d].o.id==c&&this.instances[d].o.iid==a)return this.instances[d];return!1},set:function(c){if(this.exist(c.o.id,c.o.iid))return!1;this.instances.push(c);return!0},exist:function(c,a){this.clean();for(var d=
0;d<this.instances.length;d++)if(this.instances[d].o.id==c&&("undefined"===typeof a||this.instances[d].o.iid==a))return!0;return!1},clean:function(){var c=[],a=this;this.instances.forEach(function(d,b){0==k(".asp_m_"+d.o.rid).length&&c.push(b)});c.forEach(function(d){a.instances[d].destroy();a.instances.splice(d,1)})},destroy:function(c,a){var d=this.get(c,a);if(!1!==d)if(Array.isArray(d))d.forEach(function(f){f.destroy()}),this.instances=[];else{var b=0;this.instances.forEach(function(f,e){f.o.id==
c&&f.o.iid==a&&(b=e)});d.destroy();this.instances.splice(b,1)}}};g.ASP.getScope=function(){if("undefined"!==typeof k)if("undefined"==typeof k.fn.ajaxsearchpro)for(var c=k,a=0;10>a;a++)if("undefined"==typeof c.fn.ajaxsearchpro)c=k.noConflict(!0);else return g.jQuery=g.$=k,c;else return k;return g.jQuery};g.ASP.initialized=!1;g.ASP.initialize=function(c){if("undefined"==typeof this.getScope||"undefined"==typeof this.version)return!1;var a=this.getScope(),d=".asp_init_data";"undefined"!==typeof c&&(d=
"div[id*=asp_init_id_"+c+"]");a(d).each(function(){var f=a(this).closest(".asp_w_container").find(".asp_m"),e=a(this).data("aspdata");if("undefined"===typeof e||0==f.length||"undefined"!=typeof f.get(0).hasAsp)return!0;e=g.ASP.Base64.decode(e);if("undefined"===typeof e||""==e)return!0;f.addClass("hasASP");f.get(0).hasAsp=!0;return f.ajaxsearchpro(JSON.parse(e))});if(this.highlight.enabled){var b=localStorage.getItem("asp_phrase_highlight");localStorage.removeItem("asp_phrase_highlight");null!=b&&
(b=JSON.parse(b),a.each(this.highlight.data,function(f,e){if(e.id==b.id)return f=""!=e.selector&&0<a(e.selector).length?e.selector:"article",f=0<a(f).length?f:"body",a(f).highlight(b.phrase,{element:"span",className:"asp_single_highlighted_"+b.id,wordsOnly:e.whole,excludeParents:".asp_w, .asp-try"}),e.scroll&&0<a(".asp_single_highlighted_"+b.id).length&&(f=a(".asp_single_highlighted_"+b.id).offset().top-120,0<a("#wpadminbar").length&&(f-=a("#wpadminbar").height()),f+=e.scroll_offset,f=0>f?0:f,a("html").animate({scrollTop:f},
{duration:500})),!1}))}this.initialized=!0};g.ASP.ready=function(){var c=this,a=c.getScope(),d=null;a(function(){c.initialize()});a(document).on("load",function(){c.initialized||(c.initialize(),console.log("ASP initialized via window.load"))});if("undefined"!=typeof ASP.detect_ajax&&1==ASP.detect_ajax){var b=new MutationObserver(function(){clearTimeout(d);d=setTimeout(function(){c.initialize()},500)});function h(){var l=document.querySelector("body");l?b.observe(l,{subtree:!0,childList:!0}):g.setTimeout(h,
500)}h()}var f,e="#menu-item-search, .fa-search, .fa, .fas";e+=", .fusion-flyout-menu-toggle, .fusion-main-menu-search-open";e+=", #search_button";e+=", .mini-search.popup-search";e+=", .icon-search";e+=", .menu-item-search-dropdown";e+=", .mobile-menu-button";e+=", .td-icon-search, .tdb-search-icon";e+=", .side_menu_button, .search_button";e+=", .raven-search-form-toggle";e+=", [data-elementor-open-lightbox], .elementor-button-link, .elementor-button";e+=", i[class*=-search], a[class*=-search]";
a(function(){a("body").on("click touchend",e,function(){clearTimeout(f);f=setTimeout(function(){c.initialize()},500)})});if("undefined"!=typeof k)k(document).on("elementor/popup/show",function(){setTimeout(function(){c.initialize()},10)})};g.ASP.api=function(){var c=function(b,f,e,h){b=ASP.instances.get(b,f);return!1!==b&&b[e].apply(b,[h])},a=function(b,f,e){if(!isNaN(parseFloat(f))&&isFinite(f))return b=ASP.instances.get(b,f),!1!==b&&b[e].apply(b);b=ASP.instances.get(b);return!1!==b&&b.forEach(function(h){h[f].apply(h,
[e])})},d=function(b,f){if("exists"==f)return ASP.instances.exist(b);b=ASP.instances.get(b);return!1!==b&&b.forEach(function(e){e[f].apply(e)})};if(4==arguments.length)return c.apply(this,arguments);if(3==arguments.length)return a.apply(this,arguments);if(2==arguments.length)return d.apply(this,arguments);0==arguments.length&&(console.log("Usage: ASP.api(id, [optional]instance, function, [optional]args);"),console.log("For more info: https://knowledgebase.ajaxsearchpro.com/other/javascript-api"))};
g._ASP=ASP;g._ASP.ready()})(aspjQuery,aspjQuery,window);
