...
/*$query = new \OGK\Utilities;

$pages = $query->get_all('page');*/
...
get_header();   ?>
	...
	<div id="top" class="page container" role="document">
		<header role="banner">
  ...
  p q r s t u v w x y z { | } ~ </pre>
			...
			<section id="embedded">
				...
				<article id="embedded__iframe">
					...
					<div><iframe src="https://ogkcreative.com" height="500" width="100%"></iframe></div>
					<footer><p><a href="#top">[Top]</a></p></footer>
				</article>
			</section>
			<section id="forms">
